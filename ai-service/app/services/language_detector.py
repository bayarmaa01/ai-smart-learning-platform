...
MONGOLIAN_CYRILLIC_PATTERN = re.compile(
    r'[\u0400-\u04FF\u1800-\u18AF]'
)

# Common Mongolian words in Cyrillic script
MONGOLIAN_KEYWORDS = {
    'байна', 'юу', 'хэрхэн', 'яаж', 'ямар', 'хэн', 'хаана', 'хэзээ',
    'болно', 'болохгүй', 'тийм', 'үгүй', 'би', 'та', 'тэр', 'бид',
    'сайн', 'муу', 'их', 'бага', 'өдөр', 'шөнө', 'өнөөдөр', 'маргааш',
    'сурах', 'заах', 'хичээл', 'ном', 'сургууль', 'багш', 'оюутан',
    'асуулт', 'хариулт', 'тусламж', 'мэдээлэл', 'тайлбар',
}
...
def detect_language(text: str) -> Tuple[str, float]:
    ...
    if mongolian_ratio > 0.3 or mongolian_keyword_count >= 2:
        confidence = min(0.95, 0.5 + mongolian_ratio * 0.5 + mongolian_keyword_count * 0.1)
